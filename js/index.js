...
* @Last Modified time: 2018-01-21 01:30:27
*/
...
function updata(){
	...
	var quality_level=document.getElementsByClassName("h3")[0];
	...
	for(var i in weather.forecast_list){
		...
		month.innerHTML=weather.forecast_list[i].date.substring(5, 7)+"/"+weather.forecast_list[i].date.substring(8);
		recent_time.appendChild(month);
		//var day=document.createElement("span");
		//day.className="recent_time";
